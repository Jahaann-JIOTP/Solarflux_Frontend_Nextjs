...
export default function NationWide() {
  ...
  <div className="flex items-center space-x-2">
    ...
    <select
      className="px-2 py-1 rounded-md text-[14px] bg-white text-black h-[32px] border border-gray-300 w-[200px]"
  ...
  <div className="flex items-center space-x-2">
    ...
    <select
      className="px-2 py-1 rounded-md bg-white text-[14px] text-black h-[32px] border border-gray-300 w-[200px]"
  ...
  <div className="flex items-center space-x-2">
    ...
    <div className="text-[14px] relative inline-flex min-w-[180px]">
      <DatePicker
        ...
        className="px-2 py-1 rounded-md bg-white text-black h-[32px] w-[270px] border border-gray-300 pr-8"
      />
...
>
  Generate
      ...
      {/* Chart Container */}
      <div className="w-full h-[45vh] mt-[80px] overflow-hidden">
