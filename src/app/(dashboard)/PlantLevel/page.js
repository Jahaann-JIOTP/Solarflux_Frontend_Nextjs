...
export default function PlantAnalysis() {
  ...
  const fetchSankeyData = async () => {
    ...
    try {
      const response = await fetch("https://solarfluxapi.nexalyze.com/sankey-data", {
        method: "POST",
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-end space-x-4 mb-4">
        ...
        <button className="px-4 py-2 rounded-md bg-blue-500 text-white cursor-pointer" onClick={fetchSankeyData}>
          Generate
        </button>
      </div>
